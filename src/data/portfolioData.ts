...
featured: false,
description: "Performed an end-to-end sales performance analysis in Excel 2025, moving from transactional data validation and business metric creation through descriptive statistics, regional and product analysis, correlation, regression, and model diagnostics. The analysis identified key revenue drivers, compared regional and product performance, evaluated relationships between variables, and critically assessed the limitations of the regression model.",
tags: [
"Excel 2025",
"Data Analysis",
"PivotTables",
...
caption: "Shows the transactional sales dataset used for the analysis, including the fields validated for duplicates, missing values, numerical consistency, and business-logic integrity."
},
{
...
caption: "Shows the statistical summary and regression output used to evaluate revenue distribution, relationships between variables, model fit, statistical significance, and overall model performance."
},
{
...
category: "AI Automation",
featured: false,
description: "Built an n8n data-quality automation that validates, cleans, standardizes, and quality-checks a messy Product Quality Control CSV dataset. The workflow validates structure, detects data-quality issues, applies safe corrections, flags questionable records for human review, generates a quality report, and produces a cleaned CSV while preserving an audit trail of changes.",
tags: [
"n8n",
"JavaScript",
"CSV",
...
githubUrl: "https://github.com/abdullxxhi",
keyHighlights: [
"Processed 944 source records and produced 943 valid records across 10 columns.",
"Detected invalid dates, numeric issues, production-count inconsistencies, missing defect types, and structural problems.",
"Standardized QC results and safely corrected defect-type inconsistencies.",
"Preserved questionable production values instead of inventing corrections and flagged them for human review.",
"Cleaned 525 records while leaving 418 records unchanged.",
"Flagged 320 records for review and generated a quality summary and report.",
"Produced a cleaned CSV and quality report while maintaining a clear audit trail of changes."
 ],
automationScreenshots: [
{
image: projectQualityControlWorkflowImg,
title: "Data Cleaning & Validation Workflow",
caption: "Shows the complete n8n workflow used to validate the source CSV, detect data-quality issues, clean records, generate a quality report, and create the cleaned dataset."
},
{
image: projectQualitySourceDataImg,
title: "Source Data Quality",
caption: "Shows the messy source dataset and data-quality issues identified before automated cleaning and validation."
},
{
image: projectQualityCleanedDataImg,
title: "Cleaned Dataset",
caption: "Shows the resulting cleaned and standardized dataset produced by the n8n automation."
},
{
image: projectQualityReportImg,
title: "Data Quality Report",
caption: "Shows the generated quality report summarizing validation results, corrections, unchanged records, and records requiring human review."
}
 ]
}
];
